<?php
/**
 * Adds the CSS from the Customizer options to the site's front end.
 *
 * @package		Zonew3\GenesisZonew3StarterChild\Lib\Components\Customizer
 * @since		1.0.0
 * @author		Stéphane Bergeron, Zone W3 Média Design inc.
 * @link		http://zonew3.com
 * @license GNU General Public License 2.0+
 */
namespace Zonew3\GenesisZonew3StarterChild\Customizer;
